...
class Test(models.Model):
    ...
    def time_left(self):
        return (self.start_time + timezone.timedelta(minutes=self.test_preset.duration)) - timezone.now()

    def time_left_readable(self):
        return timesince(timezone.now(), self.start_time + timezone.timedelta(minutes=self.test_preset.duration))
